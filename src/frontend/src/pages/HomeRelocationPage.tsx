  ...
  return (
    ...
    >
      ...
      <main className="mx-auto max-w-3xl px-4 py-16">
        <a
          href="#/"
          data-ocid="home_relocation.back.button"
        ...
        >
          ...
          >
            MoveX uses a system-driven approach to handle your home move with
            precision.
          </p>
          ...
          <ul className="space-y-3 mb-8">
            {[
              "Professional packing with high-grade materials",
              "Trained team assigned based on your home size",
              "Real-time tracking of your move",
          ...
          >
            Every move is planned, executed, and monitored to ensure zero damage
            and zero stress.
          </p>
          ...
          <a
            ...
            data-ocid="home_relocation.whatsapp.primary_button"
